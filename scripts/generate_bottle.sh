...
mkdir -p ${PROJECT}/${VERSION}/opt/leopays/lib/cmake
...
echo "class Leopays < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/leopays-core/leopays/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/leopays-core/leopays/releases/download/v${VERSION}\"
