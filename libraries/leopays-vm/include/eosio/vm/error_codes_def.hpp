...
GENERATE_ERROR_CATEGORY(parser_errors, "leopays-vm parser errors")
GENERATE_ERROR_CATEGORY(memory_errors, "leopays-vm memory errors")
GENERATE_ERROR_CATEGORY(system_errors, "leopays-vm system errors")
GENERATE_ERROR_CATEGORY(auxiliary_errors, "leopays-vm auxiliary errors")
