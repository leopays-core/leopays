...
read -d '' genesis << EOF
{
  "initial_timestamp": "2020-11-11T12:00:00.000",
  "initial_key": "LPC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
...
private-key = ['LPC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV','5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3']
...
programs/launcher/leopays-launcher -p $pnodes -n $total_nodes --nogen -d $delay
...
b5idbios=`./programs/cli/leopays-cli -u http://localhost:8888 get block 5 | grep "^ *\"id\""`
b5id00=`./programs/cli/leopays-cli -u http://localhost:8889 get block 5 | grep "^ *\"id\""`
b5id01=`./programs/cli/leopays-cli -u http://localhost:8890 get block 5 | grep "^ *\"id\""`
