...
class Utils:
    ...
    CliPath="programs/cli/leopays-cli"
    MiscCliArgs="--no-auto-wallet"

    WalletName="leopays-wallet"
    WalletPath="programs/wallet/"+ WalletName

    NodeName="leopays-node"
    NodePath="programs/node/"+ NodeName

    LauncherPath="programs/launcher/leopays-launcher"
    MongoPath="mongo"
    ShuttingDown=False
    CheckOutputDeque=deque(maxlen=10)

    BlockLogPath="programs/blocklog/leopays-blocklog"

    FileDivider="================================================================="
    DataDir="var/lib/"
    ConfigDir="etc/leopays/"
