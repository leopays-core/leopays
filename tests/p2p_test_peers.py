...
class P2PTestPeers:
    ...
    ports = [8888] # leopays-node listening port of each host
    ...
    #ports = [8888, 8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888, 8888] # leopays-node listening port of each host
