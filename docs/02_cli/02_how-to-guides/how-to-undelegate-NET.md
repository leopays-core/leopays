...
Undelegate 0.01 LPC network bandwidth from account `alice` back to account `bob`:
...
#         lpc <= lpc::undelegatebw          {"from":"alice","receiver":"bob","unstake_net_quantity":"0.01 LPC","unstake_cpu_qu...
