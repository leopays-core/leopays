...
## Command
A set of LeoPays keys is required to create an account. The LeoPays keys can be generated by using `leopays-cli create key`.

```sh
leopays-cli create account inita tester LPC4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcursVHq LPC7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAB3iM9SA
```
