...
- `sender` _TEXT_ - The account sending LPC
- `recipient` _TEXT_ - The account receiving LPC
- `amount` _UINT_ - The amount of LPC to send
...
## Example
Transfer 1000 LPC from **inita** to **tester**

```sh
leopays-cli transfer inita tester 1000
```
