...
```sh
# command-line
leopays-node ... --plugin eosio::trace_api_plugin [options]
```
...
```sh
# command-line
leopays-node ... --plugin eosio::chain_plugin [options]  \
           --plugin eosio::http_plugin [options]
```

## Configuration Example

Here is a `leopays-node` configuration example for the `trace_api_plugin` when tracing some LeoPays reference contracts:

```sh
leopays-node --data-dir data_dir --config-dir config_dir --trace-dir traces_dir
--plugin eosio::trace_api_plugin 
--trace-rpc-abi=eosio=abis/eosio.abi 
--trace-rpc-abi=lpc.token=abis/lpc.token.abi 
--trace-rpc-abi=lpc.msig=abis/lpc.msig.abi 
--trace-rpc-abi=lpc.wrap=abis/lpc.wrap.abi
```
