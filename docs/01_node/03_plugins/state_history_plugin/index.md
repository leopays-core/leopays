...
```sh
# command-line
leopays-node ... --plugin eosio::state_history_plugin [operations] [options]
```

## Operations

These can only be specified from the `leopays-node` command-line:
...
### history-tools
  ...
  * [Source code](https://github.com/leopays-core/history-tools/)
...
```sh
# command-line
leopays-node ... --plugin eosio::chain_plugin --disable-replay-opts
```
